...
namespace SSS.Cache.Redis.Service
{
    /// <summary>
    ...
    public class RedisStringService : RedisHelper
    {
        ...
        /// <param name="customKey">自定义Key</param>
        public RedisStringService(DbNum? dbNum = null, string customKey = null) :
            base(dbNum,customKey)
        { }
        #endregion
